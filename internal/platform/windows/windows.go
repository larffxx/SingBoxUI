...
type System struct {
	...
	Autostart *Autostart
	// Applications is the Windows application catalog: the programs this machine
	// runs and the programs its Start Menu offers (ADR 013).
...
func New() (*System, error) {
	...
	return &System{
		DataDir:         dataDir,
		Autostart:       autostart,
		Applications:    NewApplications(dataDir),
